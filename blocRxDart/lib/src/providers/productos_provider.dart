...
class ProductosProvider{
  //https://react-mdl-default-rtdb.firebaseio.com/
  final String _url = 'react-mdl-default-rtdb.firebaseio.com';
  ...
  Future<String> subirImagen(File imagen)async{
    final url = Uri.parse('https://@api.cloudinary.com/v1_1/osolozano/image/upload?upload_preset=ckhvhlls');
