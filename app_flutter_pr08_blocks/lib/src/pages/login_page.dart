...
import 'package:app_flutter_pr08_blocks/bloc/provider.dart';
...
class LoginPage extends StatelessWidget {
  ...
  Widget _loginForm(BuildContext context) {
    final bloc = Provider.of(context); // Se llama hasta encontrar la instancia
  ...
  Widget _crearBoton(LoginBloc bloc) {
    ...
    return StreamBuilder(
      stream: bloc.emailStream,
      builder: (BuildContext context, AsyncSnapshot snapshotEmail) {
        return StreamBuilder(
          stream: bloc.passwordStream,
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            return RaisedButton(
              ...
              onPressed: snapshotEmail.hasError || snapshot.hasError || snapshot.data == null || snapshotEmail.data == null ? null : () {},
            );
          },
        );
      },
